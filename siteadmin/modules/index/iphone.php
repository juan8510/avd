...
if(isset($_POST['submit_media_mp4'])){
    ...
    $mobile_view_limit		= $filter->get('mobile_view_limit', 'INTEGER');
    $mobile_template		= $filter->get('mobile_template');
	$mobile_default_type	= $filter->get('mobile_default_type');
	...
	if(!$errors){	
		...
		$config['mobile_template']		= $mobile_template;
		$config['mobile_default_type']	= $mobile_default_type;
