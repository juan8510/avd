...
if ($vinfo['General_FileExtension'] == "flv" && $vinfo['General_Format'] == "Flash Video"){
	$config['copyd'] = true;
}elseif (($vinfo['General_FileExtension'] == "flv" || $vinfo['General_FileExtension'] == "mp4") && $vinfo['General_Format'] == "MPEG-4" && $vinfo['Video_Format'] == "AVC" && stristr($vinfo['Video_Title'], "Google Inc.") !== false){
	$config['copyd'] = true;
	$hd_overwrite = true;
