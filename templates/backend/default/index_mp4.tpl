     <div id="rightcontent">
        ...
        <div id="right">
        <div align="center">
        <h2>HD (High Definition / H.264) Settings</h2>
        <div id="simpleForm">
        ...
        <legend>HD Configuration</legend>
          ...
          <legend>HD Encoding Settings</legend>  
	        ...
	        <small style="color:#bbb; font-weight:0.8em;">Default: <i>960</i></small><br>
	         <!-- Resize Height -->
	        ...
	        <small style="color:#bbb; font-weight:0.8em;">Default: <i>48000</i></small><br>       
