     <div id="rightcontent">
        ...
        <div id="right">
        <div align="center">
        <h2>FLV (Standard Quality / H.263) Settings</h2>
        <div id="simpleForm">
        <form name="media_settings" method="POST" action="index.php?m=flv">  
         ...
         <legend>FLV Encoding Settings</legend>  
	        ...
	        <small style="color:#bbb; font-weight:0.8em;">Default: <i>600</i></small><br> 
			</div>
			<!-- Blackbars -->
	        ...
	        <small style="color:#bbb; font-weight:0.8em;">Default: <i>630</i></small><br>
	         <!-- Resize Height -->
	        ...
	        <small style="color:#bbb; font-weight:0.8em;">Default: <i>473</i></small><br>  
