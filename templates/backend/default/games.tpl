        ...
        <div id="right">
            ...
            <tr bgcolor="{cycle values="#F8F8F8,#F2F2F2"}">
                ...
                <td align="center">
                    ...
                    <a href="games.php?m={$module}&a=delete&GID={$games[i].GID}" onClick="javascript:return confirm('Are you sure you want to delete this game?');">Delete</a><br>
                    {if $games[i].status == '1'}
                    <a href="games.php?m={$module}&a=suspend&GID={$games[i].GID}" onClick="javascript:return confirm('Are you sure you want to suspend this game?');">Suspend</a>
                    {else}
                    <a href="games.php?m={$module}&a=activate&GID={$games[i].GID}" onClick="javascript:return confirm('Are you sure you want to activate this game?');">Activate</a>
                    {/if}
                    <br>
                </td>
            </tr>
