        ...
        <div id="right">
            ...
            <tr bgcolor="{cycle values="#F8F8F8,#F2F2F2"}">
                ...
                <td align="center">
                    ...
                    <a href="blogs.php?m=all&a=delete&BID={$blogs[i].BID}" onClick="javascript:return confirm('Are you sure you want to delete this blog?');">Delete</a><br>
                    {if $blogs[i].status == '1'}
                    <a href="blogs.php?m=all&a=suspend&BID={$blogs[i].BID}" onClick="javascript:return confirm('Are you sure you want to suspend this blog?');">Suspend</a>
                    {else}
                    <a href="blogs.php?m=all&a=activate&BID={$blogs[i].BID}" onClick="javascript:return confirm('Are you sure you want to approve this blog?');">Activate</a>
                    {/if}
                </td>
            </tr>
            {/section}
