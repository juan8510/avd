     <div id="rightcontent">
        ...
        <legend>Album Cover</legend>
            ...
            <img src="{$relative}/media/albums/{$album.AID}.jpg?{0|rand:100}" id="current_cover" /><br />
            <label for="select_cover">Select Cover:</label><br />
            <div class="select_cover">
                {section name=i loop=$photos}
                <a href="albums.php?m=viewphoto&AID={$album.AID}&PID={$photos[i].PID}" id="album_photo_{$photos[i].PID}"><img src="{$relative}/media/photos/tmb/{$photos[i].PID}.jpg" id="album_photo_{$photos[i].PID}" /></a>
                {/section}
            </div><br />
            ...
            <img src="{$relative}/media/albums/{$album.AID}.jpg" id="album_cover" class="album_cover" /><br />
        </fieldset>
