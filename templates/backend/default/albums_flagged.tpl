        ...
        <div id="right">
            ...
            <tr bgcolor="{cycle values="#F8F8F8,#F2F2F2"}">
                ...
                <td align="center">
                    ...
                    <a href="albums.php?m=flagged&a=suspend&PID={$photos[i].PID}" onClick="javascript:return confirm('Are you sure you want to suspend this photo?');">Suspend</a>
                    {else}
                    <a href="albums.php?m=flagged&a=activate&PID={$photos[i].PID}" onClick="javascript:return confirm('Are you sure you want to approve this photo?');">Activate</a>
                    {/if}
                    <br>
                    <a href="albums.php?m=flagged&FID={$photos[i].FID}&a=unflag" onClick="javascript:return confirm('Are you sure you want to unflag this photo?');">Unflag</a>
                </td>
            </tr>
            {/section}
            {else}
