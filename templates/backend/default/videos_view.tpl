     <div id="rightcontent">
        ...
        <tr>
            ...
            <td width="30%" valign="top" align="center">
                <h2>View Video</h2>
                {if $video[0].embed_code == ''}
				<embed src="{$baseurl}/media/player/player_adv.swf" width="300" height="220" allowscriptaccess="always" allowfullscreen="true" flashvars="height=220&width=300&file={$baseurl}/media/videos/flv/{$video[0].VID}.flv&image={$tmburl}/{$video[0].VID}/{$video[0].thumb}.jpg&displayheight=220&searchbar=false" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" />
				<br><br>
                {else}
                {$video[0].embed_code}
                {/if}
                <br><br>
                <img src="{$tmburl}/{$video[0].VID}/1.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/2.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/3.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/4.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/5.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/6.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/7.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/8.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/9.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/10.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/11.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/12.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/13.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/14.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/15.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/16.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/17.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/18.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/19.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/20.jpg" width="72" class="thumb"> &nbsp;
                <img src="{$tmburl}/{$video[0].VID}/default.jpg" width="72" class="thumb"><br>
