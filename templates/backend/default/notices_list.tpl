        ...
        <div id="right">
            ...
            <tr bgcolor="{cycle values="#F8F8F8,#F2F2F2"}">
                ...
                <td align="center">
                    ...
                    <a href="notices.php?m=list&a=suspend&NID={$notices[i].NID}" onClick="javascript:return confirm('Are you sure you want to suspend this notice?');">Suspend</a>
                    {else}
                    <a href="notices.php?m=list&a=activate&NID={$notices[i].NID}" onClick="javascript:return confirm('Are you sure you want to activate this notice?');">Activate</a>
                    {/if}
                    <br>
                    <a href="notices.php?m=list&a=delete&NID={$notices[i].NID}" onClick="javascript:return confirm('Are you sure you want to delete this notice?');">Delete</a><br>
                </td>
            </tr>
            {/section}
            {else}
