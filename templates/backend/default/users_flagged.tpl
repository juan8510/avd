        ...
        <div id="right">
            ...
            <tr bgcolor="{cycle values="#F8F8F8,#F2F2F2"}">
                ...
                <td align="center">
                    ...
                    <img src="../media/users/{if $users[i].photo == ''}nopic.gif{else}{$users[i].photo}{/if}" width="70"></a>
                </td>
                <td align="center">
                ...
                <td align="center">
                    ...
                    <a href="users.php?m=flagged&a=delete&UID={$users[i].UID}" onClick="javascript:return confirm('Are you sure you want to delete this user?');">Delete</a><br>
                    {if $users[i].account_status == 'Active'}
                    <a href="users.php?m=flagged&a=suspend&UID={$users[i].UID}" onClick="javascript:return confirm('Are you sure you want to suspend this user?');">Suspend</a>
                    {else}
                    <a href="users.php?m=flagged&a=activate&UID={$users[i].UID}" onClick="javascript:return confirm('Are you sure you want to activate this user?');">Activate</a>
                    {/if}
                    <br>
                    <a href="users.php?m=mail&email={$users[i].email}&username={$users[i].username}">Email</a><br />
                    <a href="users.php?m=flagged&a=unflag&FID={$users[i].flag_id}" onClick="javascript:return confirm('Are you sure you want to unflag this user?');">Unflag</a>
                </td>
            </tr>
            {/section}
            {else}
