        ...
        <div id="right">
            ...
            <tr bgcolor="{cycle values="#F8F8F8,#F2F2F2"}">
                ...
                <td align="center">
                    ...
                    <img src="{$tmburl}/{$videos[i].VID}/{$videos[i].thumb}.jpg"></a>
                </td>
                <td align="center">
                ...
                <td align="center">
                    ...
                    <a href="videos.php?m=flagged&a=suspend&VID={$videos[i].VID}" onClick="javascript:return confirm('Are you sure you want to suspend this video?');">Suspend</a>
                    {else}
                    <a href="videos.php?m=flagged&a=activate&VID={$videos[i].VID}" onClick="javascript:return confirm('Are you sure you want to approve this video?');">Activate</a>
                    {/if}
                    <br>
                    {/if}
                    <a href="videos.php?m=flagged&FID={$videos[i].FID}&a=unflag" onClick="javascript:return confirm('Are you sure you want to unflag this video?');">Unflag</a>
                </td>
            </tr>
            {/section}
            {else}
