$(document).ready(function(){
    ...
    $("#share_game a").click(function(event) {
        ...
        $("#share_game_box").slideToggle(); 
    });
    $("#flag_game a").click(function(event) {
        event.preventDefault();
        $("#flag_game_box").slideToggle();
    });
    ...
    $("a[id*='p_game_comments_']").livequery('click', function(event) {
        event.preventDefault();
    ...
    $("a[id*='_related_games_']").livequery('click', function(event) {
        event.preventDefault();
        ...
        function(response) {
            if ( response.status == '1' ) {
                var related_div = $('#related_games_container');
                $(related_div).hide();
