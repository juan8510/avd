...
$sql            = "SELECT v.VID, v.title, v.rate, v.viewnumber, v.duration, v.type, v.thumb, v.thumbs, v.hd
                   FROM video AS v, favourite AS f
                   WHERE f.UID = " .$uid. " AND f.VID = v.VID ORDER BY v.addtime DESC LIMIT " .$limit;
$rs             = $conn->execute($sql);
